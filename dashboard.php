...
<html lang="en">
  ...
  <body>
    <?php 
      session_start();
      include 'connect.php';
      $sql= "SELECT*FROM konten LEFT JOIN artikel ON konten.id = artikel.konten_id ";
          if (isset($_POST['submit_filter'])) {
            if ($_POST['kategori_id'] !== " ") {
              $sql = "SELECT*FROM konten JOIN artikel ON konten.id=artikel.konten_id JOIN kategori ON konten.kategori_id=kategori.id
